...
No challenges but didn't get the chance to finish the persistance stretch story.
...
Had to run project to create build files. Had to follow profiles to get initial tweets to display.
